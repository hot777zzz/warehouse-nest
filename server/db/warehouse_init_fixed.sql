...
-- 删除仓库相关表（如果存在）
DROP TABLE IF EXISTS `wh_category_closure`;
...
-- 分类层级关系表 (如果需要树形结构支持)
-- ----------------------------
CREATE TABLE `wh_category_closure` (
  `ancestor` int NOT NULL COMMENT '祖先',
  `descendant` int NOT NULL COMMENT '后代',
  `depth` int DEFAULT 0 COMMENT '深度',
  PRIMARY KEY (`ancestor`, `descendant`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='分类层级关系表';
...
VALUES ('仓库管理', 0, 5, 'warehouse', NULL, '', 1, 0, 'M', '0', '0', '', 'example', 'admin', '仓库管理目录');

SET @warehouse_menu_id = LAST_INSERT_ID();

-- 数据看板
INSERT INTO `sys_menu` (`menu_name`, `parent_id`, `order_num`, `path`, `component`, `query`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `remark`)
VALUES ('数据看板', @warehouse_menu_id, 1, 'dashboard', 'warehouse/dashboard/index', '', 1, 0, 'C', '0', '0', 'warehouse:dashboard:list', 'chart', 'admin', '数据看板菜单');

-- 物资管理
INSERT INTO `sys_menu` (`menu_name`, `parent_id`, `order_num`, `path`, `component`, `query`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `remark`)
VALUES ('物资管理', @warehouse_menu_id, 2, 'material', 'warehouse/material/index', '', 1, 0, 'C', '0', '0', 'warehouse:material:list', 'list', 'admin', '物资管理菜单');

SET @material_menu_id = LAST_INSERT_ID();

-- 物资管理按钮
INSERT INTO `sys_menu` (`menu_name`, `parent_id`, `order_num`, `path`, `component`, `query`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `remark`)
VALUES ('物资查询', @material_menu_id, 1, '', NULL, '', 1, 0, 'F', '0', '0', 'warehouse:material:query', '#', 'admin', '');
INSERT INTO `sys_menu` (`menu_name`, `parent_id`, `order_num`, `path`, `component`, `query`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `remark`)
VALUES ('物资新增', @material_menu_id, 2, '', NULL, '', 1, 0, 'F', '0', '0', 'warehouse:material:add', '#', 'admin', '');
INSERT INTO `sys_menu` (`menu_name`, `parent_id`, `order_num`, `path`, `component`, `query`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `remark`)
VALUES ('物资修改', @material_menu_id, 3, '', NULL, '', 1, 0, 'F', '0', '0', 'warehouse:material:edit', '#', 'admin', '');
INSERT INTO `sys_menu` (`menu_name`, `parent_id`, `order_num`, `path`, `component`, `query`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `remark`)
VALUES ('物资删除', @material_menu_id, 4, '', NULL, '', 1, 0, 'F', '0', '0', 'warehouse:material:remove', '#', 'admin', '');

-- 分类管理
INSERT INTO `sys_menu` (`menu_name`, `parent_id`, `order_num`, `path`, `component`, `query`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `remark`)
VALUES ('分类管理', @warehouse_menu_id, 3, 'category', 'warehouse/category/index', '', 1, 0, 'C', '0', '0', 'warehouse:category:list', 'tree', 'admin', '分类管理菜单');

SET @category_menu_id = LAST_INSERT_ID();

-- 分类管理按钮
INSERT INTO `sys_menu` (`menu_name`, `parent_id`, `order_num`, `path`, `component`, `query`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `remark`)
VALUES ('分类查询', @category_menu_id, 1, '', NULL, '', 1, 0, 'F', '0', '0', 'warehouse:category:query', '#', 'admin', '');
INSERT INTO `sys_menu` (`menu_name`, `parent_id`, `order_num`, `path`, `component`, `query`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `remark`)
VALUES ('分类新增', @category_menu_id, 2, '', NULL, '', 1, 0, 'F', '0', '0', 'warehouse:category:add', '#', 'admin', '');
INSERT INTO `sys_menu` (`menu_name`, `parent_id`, `order_num`, `path`, `component`, `query`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `remark`)
VALUES ('分类修改', @category_menu_id, 3, '', NULL, '', 1, 0, 'F', '0', '0', 'warehouse:category:edit', '#', 'admin', '');
INSERT INTO `sys_menu` (`menu_name`, `parent_id`, `order_num`, `path`, `component`, `query`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `remark`)
VALUES ('分类删除', @category_menu_id, 4, '', NULL, '', 1, 0, 'F', '0', '0', 'warehouse:category:remove', '#', 'admin', '');

-- 供应商管理
INSERT INTO `sys_menu` (`menu_name`, `parent_id`, `order_num`, `path`, `component`, `query`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `remark`)
VALUES ('供应商管理', @warehouse_menu_id, 4, 'supplier', 'warehouse/supplier/index', '', 1, 0, 'C', '0', '0', 'warehouse:supplier:list', 'peoples', 'admin', '供应商管理菜单');

SET @supplier_menu_id = LAST_INSERT_ID();

-- 供应商管理按钮
INSERT INTO `sys_menu` (`menu_name`, `parent_id`, `order_num`, `path`, `component`, `query`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `remark`)
VALUES ('供应商查询', @supplier_menu_id, 1, '', NULL, '', 1, 0, 'F', '0', '0', 'warehouse:supplier:query', '#', 'admin', '');
INSERT INTO `sys_menu` (`menu_name`, `parent_id`, `order_num`, `path`, `component`, `query`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `remark`)
VALUES ('供应商新增', @supplier_menu_id, 2, '', NULL, '', 1, 0, 'F', '0', '0', 'warehouse:supplier:add', '#', 'admin', '');
INSERT INTO `sys_menu` (`menu_name`, `parent_id`, `order_num`, `path`, `component`, `query`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `remark`)
VALUES ('供应商修改', @supplier_menu_id, 3, '', NULL, '', 1, 0, 'F', '0', '0', 'warehouse:supplier:edit', '#', 'admin', '');
INSERT INTO `sys_menu` (`menu_name`, `parent_id`, `order_num`, `path`, `component`, `query`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `remark`)
VALUES ('供应商删除', @supplier_menu_id, 4, '', NULL, '', 1, 0, 'F', '0', '0', 'warehouse:supplier:remove', '#', 'admin', '');

-- 出入库管理
INSERT INTO `sys_menu` (`menu_name`, `parent_id`, `order_num`, `path`, `component`, `query`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `remark`)
VALUES ('出入库管理', @warehouse_menu_id, 5, 'stock', 'warehouse/stock/index', '', 1, 0, 'C', '0', '0', 'warehouse:stock:list', 'form', 'admin', '出入库管理菜单');

SET @stock_menu_id = LAST_INSERT_ID();

-- 出入库管理按钮
INSERT INTO `sys_menu` (`menu_name`, `parent_id`, `order_num`, `path`, `component`, `query`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `remark`)
VALUES ('出入库查询', @stock_menu_id, 1, '', NULL, '', 1, 0, 'F', '0', '0', 'warehouse:stock:query', '#', 'admin', '');
INSERT INTO `sys_menu` (`menu_name`, `parent_id`, `order_num`, `path`, `component`, `query`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `remark`)
VALUES ('入库操作', @stock_menu_id, 2, '', NULL, '', 1, 0, 'F', '0', '0', 'warehouse:stock:in', '#', 'admin', '');
INSERT INTO `sys_menu` (`menu_name`, `parent_id`, `order_num`, `path`, `component`, `query`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `remark`)
VALUES ('出库操作', @stock_menu_id, 3, '', NULL, '', 1, 0, 'F', '0', '0', 'warehouse:stock:out', '#', 'admin', '');